...
export function QuotesEditor({ initial }: { initial: string }) {
  ...
  return (
    <div>
      <header className="mb-8 flex items-start justify-between gap-4">
        <div>
          <h1 className="text-4xl font-medium tracking-tight">Approved Quotes</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Adrie&apos;s live quote library. Testimonial ads draw from this pool — every concept gets a different approved quote, always preferred over invented placeholders. Edits apply to the very next run.
          </p>
        </div>
        {!editing && (
          <button
