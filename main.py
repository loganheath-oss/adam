...
def nav_html(active: str = "") -> str:
    ...
    _upwork_svg = (
        '<svg class="upwork-wordmark" viewBox="0 0 296 83" fill="none" '
        'xmlns="http://www.w3.org/2000/svg" aria-label="Upwork">'
        '<path d="M81.1484 55.8323C72.8926 55.8323 67.4271 49.4463 65.9025 46.9725C67.8586 '
        '31.3239 73.583 26.3761 81.1484 26.3761C88.7138 26.3761 94.4382 32.3594 94.4382 '
        '41.1042C94.4382 49.849 88.6275 55.8323 81.1484 55.8323ZM81.1484 16.7684C67.686 '
        '16.7684 60.1493 25.5419 57.9919 34.5744C55.5468 29.9719 53.7345 23.816 52.325 '
        '18.0916H33.7135V41.2481C33.7135 49.6477 29.8877 55.8611 22.4086 55.8611C14.9295 '
        '55.8611 10.6434 49.6477 10.6434 41.2481L10.7296 18.0916H0V41.2481C0 48.008 2.1862 '
        '54.1352 6.18465 58.5076C10.2982 63.0238 15.9075 65.3826 22.4086 65.3826C35.3532 '
        '65.3826 44.3857 55.4584 44.3857 41.2481V25.6858C45.7376 30.8061 48.9594 40.644 '
        '55.1153 49.2737L49.3621 82.038H60.2644L64.0615 58.824C65.2984 59.8595 66.6216 '
        '60.7801 68.0312 61.6143C71.6844 63.9155 75.8555 65.21 80.1703 65.3538C80.1703 '
        '65.3538 80.832 65.3826 81.1771 65.3826C94.5245 65.3826 105.139 55.0557 105.139 '
        '41.1042C105.139 27.1528 94.4957 16.7684 81.1484 16.7684Z" fill="currentColor"/>'
        '<path d="M235.305 23.0389V18.0912H224.776V63.9151H235.449V45.9652C235.449 34.9192 '
        '236.455 26.9798 251.27 28.0154V17.5446C244.366 17.0268 238.987 18.4651 235.305 '
        '23.0389Z" fill="currentColor"/>'
        '<path d="M161.204 18.0931L153.466 50.1382L145.21 18.0931H131.632L123.348 50.1382'
        'L115.639 18.0931H104.823L116.674 63.9458H129.504L138.421 31.3829L147.252 63.9458'
        'H160.082L172.624 18.0931H161.204Z" fill="currentColor"/>'
        '<path d="M196.128 55.8611C188.534 55.8611 182.838 49.8778 182.838 41.1042C182.838 '
        '32.3307 188.562 26.3761 196.128 26.3761C203.693 26.3761 209.418 32.3594 209.418 '
        '41.1042C209.418 49.849 203.607 55.8611 196.128 55.8611ZM196.128 16.7684C182.694 '
        '16.7684 172.166 27.1816 172.166 41.1042C172.166 55.0269 182.694 65.3538 196.128 '
        '65.3538C209.561 65.3538 220.09 55.0269 220.09 41.1042C220.09 27.1816 209.504 '
        '16.7684 196.128 16.7684Z" fill="currentColor"/>'
        '<path d="M266.572 41.394H269.046L283.946 63.9464H295.999L278.855 38.9489C287.168 '
        '35.6984 292.749 27.2125 292.749 18.0937H282.105C282.105 27.9891 274.31 31.7287 '
        '266.572 31.7287V0H255.871V63.9464H266.543L266.572 41.394Z" fill="currentColor"/>'
        '</svg>'
    )
    return (
        '<nav class="adam-nav">'
